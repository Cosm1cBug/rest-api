import { emitMetric } from "./liveMetrics.js"
...
export function trackRequest({
    ...
    emitMetric('telemetry-update', getTelemetry())
}
...
export function getTelemetry() {
    ...
    const avgLatency = telemetry.latencySamples.length
        ? telemetry.totalLatency / telemetry.latencySamples.length
        : 0
