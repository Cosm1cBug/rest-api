...
export function trackRequest({
    ...
    if (
        telemetry.latencySamples.length > 100
    ) {
    ...
    telemetry.endpoints[endpoint] =
        (telemetry.endpoints[endpoint] || 0) + 1

    telemetry.statusCodes[status] =
        (telemetry.statusCodes[status] || 0) + 1
